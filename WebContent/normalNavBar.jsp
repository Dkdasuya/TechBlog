<nav class="navbar navbar-expand-lg navbar-light primary-background">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
            <li class="nav-item">
        		<a class="nav-link" href="profile.jsp"> <!-- <span class="	fa fa-address-book-o"></span>  -->Home</a>
      		</li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="registrationPage.jsp"> <span class="	fa fa-user-plus"></span> Register</a>
      </li>
    </ul>
